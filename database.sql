...
-- referring to the email instead of the redundancy of first name and last name
...
-- Update the file path of the inventory table
UPDATE public.inventory
...
(
    ...
    FOREIGN KEY (message_to) REFERENCES public.account (account_id),
    FOREIGN KEY (message_from) REFERENCES public.account (account_id)
);
